...
<body>
	<fmt:setBundle basename="lables" var="lb"/>
	<h1>Add Employee</h1>
	<form:form modelAttribute="employee" action="saveEmployee" method="post">
		<table border="1">
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><input type="submit" value="Save Employee" /></button>
