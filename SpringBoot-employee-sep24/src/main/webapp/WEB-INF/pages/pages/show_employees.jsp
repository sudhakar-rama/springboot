...
<script type="text/javascript">
	...
	function searchEmployee(){
		var eName = document.frm.ename.value;
		document.frm.emp_name.value=eName;
		document.frm.action="searchEmployee";
		document.frm.submit();
	}
</script>
</head>
<body>
	...
	<br />
	<form name="frm">
		<input type="hidden" name="emp_id" /> <input type="hidden"
			name="emp_name" />
		<table border="1" width="100%">
			<tr>
				<td align="left" colspan="6">Name : <input name="ename" />
				<button onClick="searchEmployee()">Search</button></td>
			</tr>
			<tr>
				<td align="right" colspan="6"><b><fmt:message
							key="employee.show-employees.date" /></b> <fmt:formatDate
